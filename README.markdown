...
Otherwise, if you downloaded this repository as a .zip file from github, you may also need to download sdk-ios version 1.3.7. It's available at https://github.com/playhaven/sdk-ios/zipball/1.3.7
